...
function App() {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-50 min-h-[80vh] md:w-[35%]" >
        ...
        <div className="addTodo my-5 flex flex-col gap-4 ">
          ...
          <button onClick={handleAdd} disabled={todo.length <= 3} className='bg-violet-800 disabled:bg-violet-300 mx-2  hover:bg-violet-950 p-4 py-2 text-white rounded-full  text-sm font-bold' >Save</button>
          </div>
        </div>
